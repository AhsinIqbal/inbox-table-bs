(function($) {
    ...
    $(".login-modal-pro, .default-popup, .modal-bounce").addClass(
        "bounce animated"
    );
    ...
    $(".Customwidth-popup-information, .modal-wobble").addClass(
        "wobble animated"
    );
    $(".FullColor-popup-information, .modal-jello").addClass("jello animated");
    $(".default-popup-PrimaryModal, .modal-bounceIn").addClass(
        "bounceIn animated"
    );
    $(".fullwidth-popup-InformationproModal, .modal-bounceInDown").addClass(
        "bounceInDown animated"
    );
    $(".Customwidth-popup-WarningModal, .modal-bounceInLeft").addClass(
        "bounceInLeft animated"
    );
    $(".FullColor-popup-DangerModal, .modal-bounceInRight").addClass(
        "bounceInRight animated"
    );
    $(".FullColor-popup-AlertModal, .modal-bounceInUp").addClass(
        "bounceInUp animated"
    );
